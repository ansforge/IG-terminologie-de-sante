...
* $TRE-R282-CNAMAmeliSecteurConventionnement#1 "Secteur 1 ou conventionné"
* $TRE-R282-CNAMAmeliSecteurConventionnement#2 "Conventionné Dépassement Permanent"
* $TRE-R282-CNAMAmeliSecteurConventionnement#3 "Secteur 2"