...
* ^identifier.value = "urn:oid:1.2.250.1.213.1.1.5.8"
...
* $dcmuid#1.2.840.10008.5.1.4.1.1.88.59 "Document Références d'objets d'un examen d'imagerie selon profil IHE RAD XDS-I"
