...
ValueSet: JdvJ344TypeActEquipementMaterielLourdFiness
...
* ^identifier.value = "urn:oid:1.2.250.1.213.1.6.1.352"
* ^version = "20250603120000"
* ^status = #active
* ^experimental = false
* ^date = "2025-06-03T18:02:28.249+00:00"
* ^publisher = "Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris"
* include codes from system $tre-r392-type-act-smsse-regule where natureActivite = "https://smt.esante.gouv.fr/fhir/CodeSystem/tre-r374-nature-activite-smsse-regulee#EML"