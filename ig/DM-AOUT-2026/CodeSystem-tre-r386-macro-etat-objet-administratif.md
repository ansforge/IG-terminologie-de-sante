# Tre R386 Macro Etat Objet Administratif - Terminologies de Santé v1.12.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tre R386 Macro Etat Objet Administratif**

## CodeSystem: Tre R386 Macro Etat Objet Administratif 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/CodeSystem/tre-r386-macro-etat-objet-administratif | *Version*:20260629120000 | |
| Active as of 2026-06-29 | *Responsible:*Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:TreR386MacroEtatObjetAdministratif |
| *Other Identifiers:*OID:1.2.250.1.213.1.6.1.301 | | |

 
Nomenclature des macro-etat des structures FINESS qui dérivent de l’état de l’objet. Permet de distinguer les structures actives de celles inactives. 
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:1.2.250.1.213.1.6.1.301"
  }],
  "version" : "20260629120000",
  "name" : "TreR386MacroEtatObjetAdministratif",
