# TRE_R280_DisciplineEquipementSocial - Terminologies de Santé v1.11.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **TRE_R280_DisciplineEquipementSocial**
...
Disciplines d’équipement pour le social 

 Cette terminologie de référence (CodeSystem) est référencé dans la définition de contenu des jeux de valeurs (ValueSet) suivants : 

* [JDV_J136_DisciplineEquipementSocial_RASS](ValueSet-JDV-J136-DisciplineEquipementSocial-RASS.md)
...
```json
{
  ...
  "meta" : {
    "versionId" : "10",
    "lastUpdated" : "2026-07-06T20:13:20.594+02:00",
