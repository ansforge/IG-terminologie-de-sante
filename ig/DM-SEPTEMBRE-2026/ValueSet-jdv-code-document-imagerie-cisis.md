# JDV Code Document Imagerie CISIS - Terminologies de Santé v1.13.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-code-document-imagerie-cisis | *Version*:20260916095453 | |
| Active as of 2026-09-16 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:JdvCodeDocumentImagerieCisis |
...
```json
{
  ...
  "meta" : {
    "versionId" : "15",
    "lastUpdated" : "2026-09-18T16:13:05.307+02:00",
