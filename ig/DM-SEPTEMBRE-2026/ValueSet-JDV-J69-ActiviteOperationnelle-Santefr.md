# JDV J69 ActiviteOperationnelle Santefr - Terminologies de Santé v1.13.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **JDV J69 ActiviteOperationnelle Santefr**

## ValueSet: JDV J69 ActiviteOperationnelle Santefr 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://mos.esante.gouv.fr/NOS/JDV_J69-ActiviteOperationnelle-Santefr/FHIR/JDV-J69-ActiviteOperationnelle-Santefr | *Version*:20240531120000 | |
| Retired as of 2024-05-31 | *Responsible:*Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:JDV_J69_ActiviteOperationnelle_Santefr |
| *Other Identifiers:*OID:1.2.250.1.213.3.3.68 | | |

 
Activités opérationnelles de Santé.fr 
...
| | | |
| :--- | :--- | :--- |
|  [<prev](ValueSet-jdv-j421-niveau-confidentialite-document.demande.md) | [top](#top) |  [next>](ValueSet-JDV-J69-ActiviteOperationnelle-Santefr-testing.md) |
...
```json
{
  ...
  "id" : "JDV-J69-ActiviteOperationnelle-Santefr",
  "meta" : {
    "versionId" : "5",
  ...
  "url" : "https://mos.esante.gouv.fr/NOS/JDV_J69-ActiviteOperationnelle-Santefr/FHIR/JDV-J69-ActiviteOperationnelle-Santefr",
  "identifier" : [{
    "system" : "urn:ietf:rfc:3986",
    "value" : "urn:oid:1.2.250.1.213.3.3.68"
  }],
  "version" : "20240531120000",
  "name" : "JDV_J69_ActiviteOperationnelle_Santefr",
  "title" : "JDV J69 ActiviteOperationnelle Santefr",
  "status" : "retired",
  "experimental" : false,
  "date" : "2024-05-31T12:00:00+01:00",
  "publisher" : "Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris",
  "description" : "Activités opérationnelles de Santé.fr",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "compose" : {
    "include" : [{
      ...
      {
        "code" : "035",
        "display" : "Coordination hospitalière de prélèvement d'organes et de tissus"
      },
      {
        "code" : "037",
      ...
      {
        "code" : "127",
        "display" : "Réanimation médico-chirurgicale (polyvalente)"
      },
      {
        "code" : "128",
      ...
      {
        "code" : "227",
        "display" : "Psychiatrie infanto-juvénile (pédopsychiatrie)"
      },
      {
        "code" : "228",
        "display" : "Psychiatrie des adolescents (pédopsychiatrie) et jeunes adultes"
      },
      {
        "code" : "229",
      ...
      {
        "code" : "305",
        "display" : "Accompagnements dans l'activité professionnelle"
      },
      {
        "code" : "306",
      ...
      {
        "code" : "308",
        "display" : "Accompagnements à la parentalité"
      },
      {
        "code" : "309",
      ...
      {
        "code" : "322",
        "display" : "Prestation de restauration (dont portage de repas)"
      },
      {
        "code" : "323",
      ...
      {
        "code" : "351",
        "display" : "Soins intensifs médico-chirurgicaux (polyvalent)"
      },
      {
        "code" : "352",
      ...
      {
        "code" : "373",
        "display" : "Surveillance continue médico-chirurgicale (polyvalente)"
      },
      {
        "code" : "374",
      ...
      {
        "code" : "510",
        "display" : "Échographie gynécologique et obstétricale (dont échographie de grossesse)"
      },
      {
        "code" : "511",
      ...
      {
        "code" : "527",
        "display" : "Suivi gynécologique de prévention"
      },
      {
        "code" : "528",
      ...
      {
        "code" : "548",
        "display" : "Coordination renforcée (dont Care Management)"
      },
      {
        "code" : "549",
        "display" : "Diététique"
    ...
    },
    {
      ...
      {
        "code" : "0932",
        "display" : "Tests Rapides d'Orientation Diagnostique (TROD)"
      },
      {
        "code" : "0930",
        "display" : "Evaluation et suivi des addictions liées aux achats compulsifs"
