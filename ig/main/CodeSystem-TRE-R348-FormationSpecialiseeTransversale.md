# TRE_R348_FormationSpecialiseeTransversale - Terminologies de Santé v1.11.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **TRE_R348_FormationSpecialiseeTransversale**

## CodeSystem: TRE_R348_FormationSpecialiseeTransversale 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://mos.esante.gouv.fr/NOS/TRE_R348-FormationSpecialiseeTransversale/FHIR/TRE-R348-FormationSpecialiseeTransversale | *Version*:20251222120000 | |
| Active as of 2025-12-22 | *Responsible:*Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:TRE_R348_FormationSpecialiseeTransversale |
| *Other Identifiers:*OID:1.2.250.1.213.1.6.1.251 | | |
...
```json
{
  ...
  "meta" : {
    "versionId" : "8",
    "lastUpdated" : "2026-07-06T20:13:48.298+02:00",
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:1.2.250.1.213.1.6.1.251"
  }],
  "version" : "20251222120000",
  "name" : "TRE_R348_FormationSpecialiseeTransversale",
  "status" : "active",
  "experimental" : false,
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "FST Cancéro hém-canc péd"
    },
    {
      "language" : "fr-FR",
      "use" : {
      ...
      "value" : "FST cancérologie déclinaison hémato-cancérologie pédiatrique"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2023-03-31T12:00:00+01:00"
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "FST Cancéro tts médicaux"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2023-03-31T12:00:00+01:00"
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "FST Cardio pédiatr congénitale"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2023-03-31T12:00:00+01:00"
  ...
  },
  {
    ...
    },
    {
      ...
      "value" : "FST Chirurgie en situation de guerre ou de catastrophe"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2023-03-31T12:00:00+01:00"
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "FST Méd de guerre ou SSE"
    },
    {
      "language" : "fr-FR",
      "use" : {
      ...
      "value" : "FST médecine en situation de guerre ou en situations sanitaires exceptionnelles (SSE)"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2023-03-31T12:00:00+01:00"
  ...
  },
  {
    ...
    },
    {
      ...
      "value" : "FST médecine et biologie de la reproduction-andrologie"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2023-03-31T12:00:00+01:00"
