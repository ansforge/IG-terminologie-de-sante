# JDV J70 Equipement Santefr - Terminologies de Santé v1.12.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **JDV J70 Equipement Santefr**

## ValueSet: JDV J70 Equipement Santefr 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://mos.esante.gouv.fr/NOS/JDV_J70-Equipement-Santefr/FHIR/JDV-J70-Equipement-Santefr | *Version*:20240426120000 | |
| Retired as of 2024-04-26 | *Responsible:*Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:JDV_J70_Equipement_Santefr |
| *Other Identifiers:*OID:1.2.250.1.213.3.3.69 | | |

 
Equipements Santé.fr 
...
| | | |
| :--- | :--- | :--- |
|  [<prev](ValueSet-JDV-J69-ActiviteOperationnelle-Santefr.demande.md) | [top](#top) |  [next>](ValueSet-JDV-J70-Equipement-Santefr-testing.md) |
...
```json
{
  ...
  "url" : "https://mos.esante.gouv.fr/NOS/JDV_J70-Equipement-Santefr/FHIR/JDV-J70-Equipement-Santefr",
  "identifier" : [{
    "system" : "urn:ietf:rfc:3986",
    "value" : "urn:oid:1.2.250.1.213.3.3.69"
  }],
  "version" : "20240426120000",
  "name" : "JDV_J70_Equipement_Santefr",
  "title" : "JDV J70 Equipement Santefr",
  "status" : "retired",
  "experimental" : false,
  "date" : "2024-04-26T12:00:00+01:00",
  "publisher" : "Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris",
  "description" : "Equipements Santé.fr",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "compose" : {
    "include" : [{
      ...
      {
        "code" : "083",
        "display" : "Table de radiologie obésité (poids entre 150 et 250 kg) - bariatrique"
      },
      {
        "code" : "084",
        "display" : "Table de radiologie obésité (poids supérieur à 250 kg) - bariatrique"
      },
      {
        "code" : "085",
      ...
      {
        "code" : "103",
        "display" : "Assistant robotisé à la marche"
      },
      {
        "code" : "104",
        "display" : "Assistant robotisé des membres supérieurs et de la préhension"
      },
      {
        "code" : "106",
      ...
      {
        "code" : "107",
        "display" : "Salle de réanimation avec scopes, défibrillateur, matériel d'intubation et de ventilation assistée"
      },
      {
        "code" : "108",
      ...
      {
        "code" : "109",
        "display" : "Equipement de rééducation pour obésité massive"
      },
      {
        "code" : "110",
      ...
      {
        "code" : "120",
        "display" : "Plateau de simulation de conduite automobile"
      },
      {
        "code" : "121",
