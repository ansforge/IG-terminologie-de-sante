# Vs Tre R361 Fonction Publique All - Terminologies de Santé v1.12.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/CodeSystem/tre-r361-fonction-publique?vs | *Version*:20260330120000 | |
| Active as of 2026-03-30 | *Responsible:*Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:VsTreR361FonctionPubliqueAll |
...
| | | |
| :--- | :--- | :--- |
|  [<prev](ValueSet-vs-tre-r274-activite-sanitaire-regulee-all.demande.md) | [top](#top) |  [next>](ValueSet-vs-tre-r361-fonction-publique-all-testing.md) |
