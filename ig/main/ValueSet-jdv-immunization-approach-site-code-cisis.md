# JDV Immunization Approach Site Code CISIS - Terminologies de Santé v1.12.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-immunization-approach-site-code-cisis | *Version*:20260716085851 | |
| Active as of 2026-07-16 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:JdvImmunizationApproachSiteCodeCisis |
...
| | | |
| :--- | :--- | :--- |
|  [<prev](ValueSet-jdv-immunisation-vrs-cisis.demande.md) | [top](#top) |  [next>](ValueSet-jdv-immunization-approach-site-code-cisis-testing.md) |
...
```json
{
  ...
  "meta" : {
    "versionId" : "11",
    "lastUpdated" : "2026-07-17T12:59:00.456+02:00",
  ...
  "compose" : {
    "include" : [{
      ...
      {
        "code" : "91774008",
        "display" : "région de l'épaule droite"
      },
      {
        "code" : "91775009",
        "display" : "région de l'épaule gauche"
      },
      {
        "code" : "11207009",
