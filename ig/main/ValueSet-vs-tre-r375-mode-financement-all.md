# Vs Tre R375 Mode Financement All - Terminologies de Santé v1.12.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Vs Tre R375 Mode Financement All**

## ValueSet: Vs Tre R375 Mode Financement All 
...
| | | |
| :--- | :--- | :--- |
|  [<prev](ValueSet-vs-tre-r374-nature-activite-smsse-regulee-all.demande.md) | [top](#top) |  [next>](ValueSet-vs-tre-r375-mode-financement-all-testing.md) |
...
```json
{
  ...
  "compose" : {
    "include" : [{
      "system" : "https://smt.esante.gouv.fr/fhir/CodeSystem/tre-r375-mode-financement"
    }]
  }
}
