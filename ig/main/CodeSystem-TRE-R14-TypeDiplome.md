# TRE_R14_TypeDiplome - Terminologies de Santé v1.12.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://mos.esante.gouv.fr/NOS/TRE_R14-TypeDiplome/FHIR/TRE-R14-TypeDiplome | *Version*:20240329120000 | |
| Active as of 2024-03-29 | *Responsible:*Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:TRE_R14_TypeDiplome |
| *Other Identifiers:*OID:1.2.250.1.213.1.6.1.36 | | |
...
```json
{
  ...
  "meta" : {
    "versionId" : "7",
    "lastUpdated" : "2026-07-06T20:12:38.318+02:00",
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:1.2.250.1.213.1.6.1.36"
  }],
  "version" : "20240329120000",
  "name" : "TRE_R14_TypeDiplome",
  "status" : "active",
  "experimental" : false,
  ...
  {
    "code" : "CQ",
    "display" : "Commission de qualification",
    "property" : [{
      "code" : "dateValid",
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "Diplôme pays hors EU, hors EEE"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2007-07-25T15:04:42+01:00"
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "Dip études spé complém grpe 1"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2007-07-25T15:04:42+01:00"
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "Dip études spé complém grpe 2"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2007-07-25T15:04:42+01:00"
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "Dip univ (DU) inter-univ (DIU)"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2007-07-25T15:04:42+01:00"
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "Form Spécialisée Transversale"
    }],
    "property" : [{
      "code" : "dateValid",
