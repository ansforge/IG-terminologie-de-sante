# TRE_R357_StatutPersonnePriseCharge - Terminologies de Santé v1.11.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **TRE_R357_StatutPersonnePriseCharge**

## CodeSystem: TRE_R357_StatutPersonnePriseCharge 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://mos.esante.gouv.fr/NOS/TRE_R357-StatutPersonnePriseCharge/FHIR/TRE-R357-StatutPersonnePriseCharge | *Version*:20231215120000 | |
| Active as of 2023-12-15 | *Responsible:*Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:TRE_R357_StatutPersonnePriseCharge |
| *Other Identifiers:*OID:1.2.250.1.213.3.3.247 | | |

 
Statut de la personne prise en charge. 

 Cette terminologie de référence (CodeSystem) est référencé dans la définition de contenu des jeux de valeurs (ValueSet) suivants : 

* [JDV_J252_StatutPersonnePriseChargeESMS](ValueSet-JDV-J252-StatutPersonnePriseChargeESMS.md)
* [JDV_J253_StatutPersonnePriseChargeUnite](ValueSet-JDV-J253-StatutPersonnePriseChargeUnite.md)
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:1.2.250.1.213.3.3.247"
  }],
  "version" : "20231215120000",
  "name" : "TRE_R357_StatutPersonnePriseCharge",
  "status" : "active",
  "experimental" : false,
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "Période essai en cours ESMS"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2023-06-30T12:00:00+01:00"
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "Fin période d'essai ESMS"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2023-06-30T12:00:00+01:00"
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "Demande réorientation ESMS"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2023-06-30T12:00:00+01:00"
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "Retiré liste att ou acc annulé"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2023-06-30T12:00:00+01:00"
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "En cours d'analyse unité"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2023-09-22T12:00:00+01:00"
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "Période essai en cours - unité"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2023-09-22T12:00:00+01:00"
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "Demande réorientation - unité"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2023-09-22T12:00:00+01:00"
