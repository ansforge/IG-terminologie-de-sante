# Jdv J399 Motivation Ms - Terminologies de Santé v1.12.0
...
L’énoncé des considérations de droit ou de fait qui constituent le fondement de la proposition et de la décision de la CDAPH. 
...
| | | |
| :--- | :--- | :--- |
|  [<prev](ValueSet-jdv-j398-type-decision-ms.demande.md) | [top](#top) |  [next>](ValueSet-jdv-j399-motivation-ms-testing.md) |
...
```json
{
  ...
  "meta" : {
    "versionId" : "1",
    "lastUpdated" : "2026-05-27T15:47:16.005+02:00",
