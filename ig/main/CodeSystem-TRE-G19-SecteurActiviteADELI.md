# TRE_G19_SecteurActiviteADELI - Terminologies de Santé v1.11.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **TRE_G19_SecteurActiviteADELI**

## CodeSystem: TRE_G19_SecteurActiviteADELI 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://mos.esante.gouv.fr/NOS/TRE_G19-SecteurActiviteADELI/FHIR/TRE-G19-SecteurActiviteADELI | *Version*:20250523120000 | |
| Active as of 2025-05-23 | *Responsible:*Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:TRE_G19_SecteurActiviteADELI |
| *Other Identifiers:*OID:1.2.250.1.71.1.2.23 | | |

 
Secteur d’activité ADELI 
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:1.2.250.1.71.1.2.23"
  }],
  "version" : "20250523120000",
  "name" : "TRE_G19_SecteurActiviteADELI",
  "status" : "active",
  "experimental" : false,
  ...
  {
    "code" : "43",
    "display" : "Etablissement scolaire ou universitaire",
    "designation" : [{
      "language" : "fr-FR",
      "use" : {
        "system" : "http://snomed.info/sct",
      ...
      "value" : "Etab scolaire ou universitaire"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2007-07-25T15:04:44+01:00"
  ...
  {
    "code" : "55",
    "display" : "Etablissement d'enseignement",
    "designation" : [{
      "language" : "fr-FR",
      "use" : {
        "system" : "http://snomed.info/sct",
  ...
  },
  {
    ...
    {
      "code" : "dateMaj",
      "valueDateTime" : "2010-11-18T00:00:00+01:00"
    },
    {
      "code" : "status",
      "valueCode" : "active"
  ...
  {
    "code" : "71",
    "display" : "Laboratoire (d'analyse et) de biologie médicale",
    "designation" : [{
      "language" : "fr-FR",
      "use" : {
        "system" : "http://snomed.info/sct",
    ...
    },
    {
      ...
      "value" : "Laboratoire (d'analyse et) de biologie médicale (LBM ou LABM)"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2007-07-25T15:04:44+01:00"
  ...
  },
  {
    ...
    {
      "code" : "dateMaj",
      "valueDateTime" : "2009-08-24T00:00:00+01:00"
    },
    {
      "code" : "status",
      "valueCode" : "active"
  ...
  },
  {
    ...
    "designation" : [{
      ...
      "value" : "Ent industrielle et tertiaire"
    },
    {
      "language" : "fr-FR",
      "use" : {
  ...
  {
    "code" : "100",
    "display" : "Structure d'urgence hors établissement hospitalier",
    "designation" : [{
      "language" : "fr-FR",
      "use" : {
        "system" : "http://snomed.info/sct",
      ...
      "value" : "Structure d'urgence hors hôp"
    }],
    "property" : [{
      "code" : "dateValid",
      "valueDateTime" : "2007-07-25T00:00:00+01:00"
