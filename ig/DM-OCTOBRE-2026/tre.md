# Terminologies - Terminologies de Santé v1.13.0
...
| [CIM11_MMS](CodeSystem-terminologie-cim11-mms.md) | La Classification Internationale des Maladies (CIM) dans sa 11ème révision permet d’établir, partout dans le monde, les statistiques sanitaires. Fournissant un langage commun pour alimenter les dossiers patients électroniques, la CIM11 permet d’échanger des données médicales de manière cohérente et normalisée pour de nombreux cas d’usage (production de soins, coordination professionnelle, pilotage, et exploitation de données) | 24/09/2026 | active |
...
| [SNOMED_CT](CodeSystem-900000000000207008-20260901.md) | SNOMED CT is the most comprehensive and precise clinical health terminology product in the world, owned and distributed around the world by The International Health Terminology Standards Development Organisation (IHTSDO). | 31/08/2026 | active |
...
| [TerminologieCISIS](CodeSystem-terminologie-cisis.md) | Terminologie multi-domaines créée et maintenue par l'ANS contenant les termes non trouvés dans les autres terminologies internationales ou nationales. | 21/09/2026 | active |
...
| [TreR430ModaliteReconnaissanceContractuelle](CodeSystem-tre-r430-modalite-reconnaissance-contractuelle.md) | Modalités des activités autorisées /exercées provenant d'E-CARS | 02/11/2026 | active |
